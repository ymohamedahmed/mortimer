...
public class Bitbase {
	...
	public boolean probe(BitBoard board) {
		int wKingIndex = Board
				.mirrorIndex(BitBoard.bitScanForward(board.bitboards[CoreConstants.WHITE_KING]));
		int bKingIndex = Board
				.mirrorIndex(BitBoard.bitScanForward(board.bitboards[CoreConstants.BLACK_KING]));
		int pIndex = Board
				.mirrorIndex(BitBoard.bitScanForward(board.bitboards[CoreConstants.WHITE_PAWN]
